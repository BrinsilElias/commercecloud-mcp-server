/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 118ac3a33ff29f15f0c85cabb37dacba)
// Runtime types generated with workerd@1.20250604.0 2025-06-08 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OAUTH_KV: KVNamespace;
		SFCC_INSTANCE_URL: string;
		SFCC_SITE_ID: string;
		SFCC_CLIENT_ID: string;
		SFCC_CLIENT_SECRET: string;
		SFCC_VERSION: string;
		SFCC_BM_USER_ID: string;
		SFCC_BM_USER_SECURITY_TOKEN: string;
		MICROSOFT_CLIENT_ID: string;
		MICROSOFT_TENANT_ID: string;
		MICROSOFT_CLIENT_SECRET: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").CommerceCloudMCP>;
		MCP_RESOURCES: R2Bucket;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SFCC_INSTANCE_URL" | "SFCC_SITE_ID" | "SFCC_CLIENT_ID" | "SFCC_CLIENT_SECRET" | "SFCC_VERSION" | "SFCC_BM_USER_ID" | "SFCC_BM_USER_SECURITY_TOKEN" | "MICROSOFT_CLIENT_ID" | "MICROSOFT_TENANT_ID" | "MICROSOFT_CLIENT_SECRET">> {}
}
